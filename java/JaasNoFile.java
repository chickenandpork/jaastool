...
/* http://aput.net/~jheiss/krbldap/files/krb5.conf
[logging]
...
/* MacOSX-10.9 krb5.conf manpage example:
           [libdefaults]
...
*/
	...
	if (1 > servers.size()) { System.out.println("FATAL: "+ /* g.progname() */ "jaastool" /* for now */ +" needs at least one \"server\" (Kerberos-to-ActiveDirectory: AD Server)"); System.exit (-1); }
